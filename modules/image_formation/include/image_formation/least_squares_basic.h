...
class LeastSquaresBasic {
   public:
    /**
         ...
         * 
         * @param[out] out_point the inhomogeneus intersection point.
         * @param[in] in_lines the martrix with n rows and m cols, where each row is a line with 
    ...
    /**
         ...
         * @param[in] in_points the matrix with n rows and m cols, where each row is a point. 
         *      Minimum 2 rows.
         * 
